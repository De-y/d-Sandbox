  ...
  return (
    <>
      <Head>
        ...
        <document href="https://fonts.googleapis.com/css?family=Poppins" rel="stylesheet"/>
      ...
      <main>
        ...
        <div className={styles.main}>
          ...
          <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-4 px-8 rounded-full mt-4 md:mt-8 lg:mt-12" style={{ marginTop: '1rem' }} onClick={handleButtonClick}>Visit GitHub Profile</button>
        </div>
